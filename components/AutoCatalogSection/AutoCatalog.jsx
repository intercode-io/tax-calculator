...
export default function AutoCatalog() {
    const getDataAuto = useFetchData('/homepage', ['catalog_autos.Auto.AutoImage', 'catalog_autos.Auto.AutoCharacteristics'])
    const DataAuto = getDataAuto?.catalog_autos.data;
